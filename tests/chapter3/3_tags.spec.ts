...
test("Validating the dropdown",{tag:['@Smoketesting']},async({page})=>{
...
test("Validating the dropdown2",{tag:['@Smoketesting','@RegressionTesting']},async({page})=>{
...
test("Validating the dropdown3",{tag:['@RegressionTesting']},async({page})=>{
